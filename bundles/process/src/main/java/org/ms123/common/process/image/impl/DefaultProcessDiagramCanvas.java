...
package org.ms123.common.process.image.impl;
...
import org.ms123.common.process.image.exception.FlowableImageException;
import org.ms123.common.process.image.util.ReflectUtil;
...
public class DefaultProcessDiagramCanvas {
    ...
    protected static Color LABEL_COLOR = Color.BLACK;//new Color(112, 146, 190);
    ...
    public void initialize(String imageType) {
        ...
        LABEL_FONT = new Font(labelFontName, Font.PLAIN, 10);
...
//            HTTP_TASK_IMAGE = ImageIO.read(ReflectUtil.getResource("org/activiti/icons/httpTask.png", customClassLoader));
    ...
    public void drawLabel(String text, GraphicInfo graphicInfo, boolean centered) {
        ...
        if (text != null && text.length() > 0) {
            ...
            int wrapWidth = 100;
            int textY = (int) graphicInfo.getY()+30;
