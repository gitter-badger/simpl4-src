 ...
 */
public class BaseEndpoint extends DefaultEndpoint {

	protected IdentityService identityService;

	protected RuntimeService runtimeService;

	protected BaseConsumer baseConsumer;
	...
	public BaseEndpoint(String uri, CamelContext camelContext) {
		super();
	...
	public void process(Exchange ex) throws Exception {
		if (baseConsumer == null) {
			throw new RuntimeException("Base consumer not defined for " + getEndpointUri());
		}
		baseConsumer.getProcessor().process(ex);
	}

	public Producer createProducer() throws Exception {
		BaseProducer producer = new BaseProducer(this, getTimeout(), getTimeResolution());
	...
	public Consumer createConsumer(Processor processor) throws Exception {
		return new BaseConsumer(this, processor);
	}

	protected void addConsumer(BaseConsumer consumer) {
		if (baseConsumer != null) {
			throw new RuntimeException("Base consumer already defined for " + getEndpointUri() + "!");
		}
