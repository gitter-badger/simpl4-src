...
public class RegisterAllBpmnParseListener extends AbstractBpmnParseListener {
	...
	public static final List<String> TASK_EVENTS = Arrays.asList(EVENTNAME_COMPLETE, EVENTNAME_ASSIGNMENT, EVENTNAME_CREATE, EVENTNAME_DELETE);
	public static final List<String> EXECUTION_EVENTS = Arrays.asList(EVENTNAME_START, EVENTNAME_END);
	...
	public void parseTransaction(Element transactionElement, ScopeImpl scope, ActivityImpl activity) {
		//@@@MS if (configuration.isActivateTransaction()) {
			addExecutionListener(activity);
		//@@@MS }
	}
